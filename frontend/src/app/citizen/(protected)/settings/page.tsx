        ...
        <div className="space-y-6 p-6 max-w-4xl mx-auto">
            ...
            <Card className="border-none shadow-xl bg-card/60 backdrop-blur-3xl rounded-3xl overflow-hidden">
                ...
                <CardContent className="pt-6 space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label className="text-base font-bold">Violation Alerts</Label>
                            <p className="text-sm text-muted-foreground">
                                Get notified when a new violation is detected
                            </p>
                        </div>
                        <Switch
                            checked={settings.violationAlerts}
                            onCheckedChange={(checked) =>
                                setSettings({ ...settings, violationAlerts: checked })
                            }
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label className="text-base font-bold">Payment Reminders</Label>
                            <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <Label className="text-base font-bold">Complaint Updates</Label>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                setSettings({ ...settings, complaintUpdates: checked })
                            }
                        />
                    </div>
                </CardContent>
